...
class Data_Siswa(Tk):
    ...
    def tampilan_gui(self):
        ...
        Label(self, text="Kode").grid(row=0, column=0, padx=10, pady=10)
        ...
        self.alamat_entry = Text(self, width=37, height=1)
        ...
        self.tree.heading("NIS", text="Kode")
        self.tree.heading("Nama", text="Nama")
        self.tree.heading("Jurusan", text="Kelompok")
        self.tree.heading("Alamat", text="Mata Pelajaran")
